...
public class BinarySlidingMenuV3 extends HorizontalScrollView {
    ...
    public BinarySlidingMenuV3(Context context) {
        this(context, null);
    }

    public BinarySlidingMenuV3(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BinarySlidingMenuV3(Context context, AttributeSet attrs, int defStyleAttr) {
