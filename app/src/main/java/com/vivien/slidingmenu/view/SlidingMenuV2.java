...
public class SlidingMenuV2 extends HorizontalScrollView {
    ...
    public SlidingMenuV2(Context context) {
        this(context, null);
    }

    public SlidingMenuV2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlidingMenuV2(Context context, AttributeSet attrs, int defStyleAttr) {
