...
public class BinarySlidingMenuV2 extends HorizontalScrollView {
    ...
    public BinarySlidingMenuV2(Context context) {
        this(context, null);
    }

    public BinarySlidingMenuV2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BinarySlidingMenuV2(Context context, AttributeSet attrs, int defStyleAttr) {
