...
import com.vivien.slidingmenu.view.BinarySlidingMenu;
import com.vivien.slidingmenu.view.MenuPageView;

import java.util.ArrayList;

public class DNormalSlidingMenuActivity extends AppCompatActivity {

    private BinarySlidingMenu mBSlidingMenu;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dnormal_sliding_menu);

        mBSlidingMenu = (BinarySlidingMenu) findViewById(R.id.slidingmenu);
        mBSlidingMenu.setOnMenuOpenListener(new BinarySlidingMenu.OnMenuOpenListener() {
            @Override
