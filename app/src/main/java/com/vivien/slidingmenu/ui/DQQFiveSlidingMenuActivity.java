...
import com.vivien.slidingmenu.view.BinarySlidingMenuV2;
import com.vivien.slidingmenu.view.MenuPageView;

import java.util.ArrayList;

public class DQQFiveSlidingMenuActivity extends AppCompatActivity {

    private BinarySlidingMenuV2 mBSlidingMenu;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dqqfive_sliding_menu);

        mBSlidingMenu = (BinarySlidingMenuV2) findViewById(R.id.slidingmenu);
        mBSlidingMenu.setOnMenuOpenListener(new BinarySlidingMenuV2.OnMenuOpenListener() {
            @Override
